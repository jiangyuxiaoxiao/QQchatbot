...
average_special_defense_pokemon = on_command("average_special_defense_pokemon", priority=56,block=False)
...
low_special_defense_pokemon = on_command("low_special_defense_pokemon", priority=56,block=False)
...
high_special_defense_pokemon = on_command("high_special_defense_pokemon", priority=56,block=False)
...
average_special_attack_pokemon = on_command("average_special_attack_pokemon", priority=57,block=False)
...
high_special_attack_pokemon = on_command("high_special_attack_pokemon", priority=57,block=False)
...
low_special_attack_pokemon = on_command("low_special_attack_pokemon", priority=57,block=False)
...
average_defense_pokemon = on_command("average_defense_pokemon", priority=57,block=False)
...
low_defense_pokemon = on_command("low_defense_pokemon", priority=57,block=False)
...
high_defense_pokemon = on_command("high_defense_pokemon", priority=57,block=False)
...
low_attack_pokemon = on_command("low_attack_pokemon", priority=57,block=False)
...
average_attack_pokemon = on_command("average_attack_pokemon", priority=57,block=False)
...
high_attack_pokemon = on_command("high_attack_pokemon", priority=57,block=False)
...
slow_pokemon = on_command("slow_pokemon", priority=57,block=False)
@slow_pokemon.handle()
async def test_handle(bot: Bot, event: Event, state: T_State):
   groupid = event.group_id
   count = 0
...
average_speed_pokemon = on_command("average_speed_pokemon", priority=57,block=False)
...
fast_pokemon = on_command("fast_pokemon", priority=57,block=False)
@fast_pokemon.handle()
async def test_handle(bot: Bot, event: Event, state: T_State):
   groupid = event.group_id
   count = 0
...
high_hp_pokemon = on_command("high_hp_pokemon", priority=57,block=False)
...
low_hp_pokemon = on_command("low_hp_pokemon", priority=57,block=False)
...
average_hp_pokemon = on_command("average_hp_pokemon", priority=57,block=False)
...
pokemon_type = on_command("pokemon_type", priority=86,block=False)
@pokemon_type.handle()
async def test_handle(bot: Bot, event: Event, state: T_State):
   groupid = event.group_id
...
pokemon_command = on_command("pokemon_command", priority=85,block=False)
...
gen1_pokemon = on_command("gen1_pokemon", priority=84,block=False)
@gen1_pokemon.handle()
async def test_handle(bot: Bot, event: Event, state: T_State):
   groupid = event.group_id
   count = 0
...
gen2_pokemon = on_command("gen2_pokemon", priority=83,block=False)
@gen2_pokemon.handle()
async def test_handle(bot: Bot, event: Event, state: T_State):
   groupid = event.group_id
   count = 0
...
gen3_pokemon = on_command("gen3_pokemon", priority=82,block=False)
@gen3_pokemon.handle()
async def test_handle(bot: Bot, event: Event, state: T_State):
   groupid = event.group_id
   count = 0
...
gen4_pokemon = on_command("gen4_pokemon", priority=81,block=False)
@gen4_pokemon.handle()
async def test_handle(bot: Bot, event: Event, state: T_State):
   groupid = event.group_id
   count = 0
...
gen5_pokemon = on_command("gen5_pokemon", priority=80,block=False)
@gen5_pokemon.handle()
async def test_handle(bot: Bot, event: Event, state: T_State):
   groupid = event.group_id
   count = 0
...
gen6_pokemon = on_command("gen6_pokemon", priority=79,block=False)
@gen6_pokemon.handle()
async def test_handle(bot: Bot, event: Event, state: T_State):
   groupid = event.group_id
   count = 0
...
strong_pokemon = on_command("strong_pokemon", priority=78,block=False)
...
weak_pokemon = on_command("weak_pokemon", priority=77,block=False)
@weak_pokemon.handle()
async def test_handle(bot: Bot, event: Event, state: T_State):
   groupid = event.group_id
   count = 0
...
average_pokemon = on_command("average_pokemon", priority=76,block=False)
...
legendary_pokemon = on_command("legendary_pokemon", priority=75,block=False)
...
fire_type_pokemon = on_command("fire_type_pokemon", priority=74,block=False)
...
water_type_pokemon = on_command("water_type_pokemon", priority=73,block=False)
...
grass_type_pokemon = on_command("grass_type_pokemon", priority=72,block=False)
...
electric_type_pokemon = on_command("electric_type_pokemon", priority=71,block=False)
...
rock_type_pokemon = on_command("rock_type_pokemon", priority=70,block=False)
...
ground_type_pokemon = on_command("ground_type_pokemon", priority=69,block=False)
...
ghost_type_pokemon = on_command("ghost_type_pokemon", priority=68,block=False)
...
dark_type_pokemon = on_command("dark_type_pokemon", priority=67,block=False)
...
psychic_type_pokemon = on_command("psychic_type_pokemon", priority=66,block=False)
...
ice_type_pokemon = on_command("ice_type_pokemon", priority=65,block=False)
...
dragon_type_pokemon = on_command("dragon_type_pokemon", priority=64,block=False)
...
steel_type_pokemon = on_command("steel_type_pokemon", priority=63,block=False)
...
fairy_type_pokemon = on_command("fairy_type_pokemon", priority=62,block=False)
...
fighting_type_pokemon = on_command("fighting_type_pokemon", priority=61,block=False)
...
normal_type_pokemon = on_command("normal_type_pokemon", priority=58,block=False)
...
flying_type_pokemon = on_command("flying_type_pokemon", priority=59,block=False)
...
poison_type_pokemon = on_command("poison_type_pokemon", priority=60,block=False)
...
bug_type_pokemon = on_command("bug_type_pokemon", priority=60,block=False)
